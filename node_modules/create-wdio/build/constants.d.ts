 ...
 */
export declare function buildTauriBanner(driverProvider: TauriDriverProviderChoice | undefined, useFrontendPlugin: boolean | undefined): string;
...
export declare enum DesktopFrameworkChoice {
    Electron = "Electron (https://www.electronjs.org/)",
    Tauri = "Tauri (https://tauri.app/)",
    MacOS = "Native macOS app"
}
export declare enum TauriDriverProviderChoice {
...
export declare function getResolvedPurpose(answers: Questionnair): "e2e" | "vscode" | "electron" | "tauri" | "roku" | "component" | "macos";
...
export declare const QUESTIONNAIRE: ({
    ...
    name: string;
    message: string;
    choices: DesktopFrameworkChoice[];
    ...
    name: string;
    message: string;
    choices: TauriDriverProviderChoice[];
    when: (answers: Questionnair) => boolean;
    default?: undefined;
} | {
    type: string;
