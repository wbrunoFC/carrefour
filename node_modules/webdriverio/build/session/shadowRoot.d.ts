...
export declare class ShadowRootManager extends SessionManager {
    ...
    getShadowElementsByContextId(contextId: string, scope?: string): Promise<string[]>;
    getShadowElementPairsByContextId(contextId: string, scope?: string): Promise<[string, string | undefined][]>;
